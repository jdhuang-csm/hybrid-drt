...
data {
	...
	// Response vectors
	vector[N] inf_rv; // R_inf response vector
...
transformed parameters {
	...
	// calculated voltage
	vector[N] V_hat = A*x + V_inst + V_baseline;
...
model {
	// replace dn_strength distributions with gamma distributions
